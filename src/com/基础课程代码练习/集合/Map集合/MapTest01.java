 ...
 *      boolean isEmpty()
 *      Set<K> keySet()                      获取Map 集合所有的 key;所有的 key 是Set com.基础课程代码练习.集合
 *
 *      int size()
 *      Collection<V> values()               获取集合Map 中所有的value ，返回一个 Collection
 *      Set<Map.Entry><K,V>entrySet<>        将 Map 集合转换成为 Set com.基础课程代码练习.集合
 *              将 Map 集合转换为 Set com.基础课程代码练习.集合
 *              假设有一个 Map com.基础课程代码练习.集合，如下所示：
 *                  map1 com.基础课程代码练习.集合
 *                  key         value
 *                  -----------------
 *                  1           zhangsan
 *                  2           Jack
 *
 *                  Set set = map1.entrySet(); // 将整个 Map 转换成为了 Set com.基础课程代码练习.集合
 *                  set 集合对象
