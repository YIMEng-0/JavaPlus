 ...
 *
 * 9、放在了 HashMap com.基础课程代码练习.集合 key 的部分就是放在了 HashSet 集合中了；
...
public class MyHashTable {
    public static void main(String[] args) {
        ...
        // 对于 Map 集合的遍历
        // map 在经过了 entrySet 之后，将这个转换成为了 Set com.基础课程代码练习.集合；并且在它的左边使用了一个 Set 集合接受此物；下面使用了增强 for 循环；
        // 在这里， Set 集合中存储的是 一个 Entry ，也就是一个键值对，下面遍历时候，分别遍历键值对，分开；
        Set<Map.Entry<Integer,String>> set = map.entrySet();
        for (Map.Entry<Integer,String> entry : set) {
            // 验证结果：HashMap com.基础课程代码练习.集合 key 部分元素，没有顺序并且是不可以重复的
