...
public class PaintCircle extends JFrame {
    private int r;
    private List<LocationOfDrunk> locations;
    private int W_H = 1000;
    private int R;
    private int G;
    private int B;

    public PaintCircle(String title, int r, List<LocationOfDrunk> locations, int R, int G, int B) {
        this.r = r;
    ...
    private double getMaxLocation() {
        double max_x = 0;
        if (locations != null && locations.size() > 0) {
            for (LocationOfDrunk loc : locations) {
